    ...
    class DatabaseCon
    {
        ...
        public void CreateUser(string user, string pass)
        {
            ...
            else if (user == "")
            {
                ...
                Console.WriteLine("Please only user letters and numbers for username");
            }
            else
            {
                ...
                using (var cmd = new SQLiteCommand())
                {
                    ...
                    cmd.ExecuteNonQuery();
                    cn.Close();
                    Console.WriteLine("Successfully added the user");
        ...
        public void DeleteUser(string user)
        {
            ...
            {
                Console.WriteLine("That username doesn't exists");
            }
            else
            {
                using (var cn = new SQLiteConnection("Data Source=Users.sqlite;Version=3;"))
